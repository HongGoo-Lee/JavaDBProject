...
public class AddPurchaseView extends JFrame {
    ...
    public AddPurchaseView(User loggedInUser) {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    boolean result = purchaseController.addPurchase(userId, productId, price);
                    if (result) {
                        JOptionPane.showMessageDialog(null, "구매 등록 성공");
                    } else {
                        JOptionPane.showMessageDialog(null, "구매 등록 실패");
                    }
